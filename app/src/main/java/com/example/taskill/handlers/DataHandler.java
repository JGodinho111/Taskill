...
public class DataHandler {
    ...
    public void writeNewServiceProvider(String userId, String name,String username, String email,String password, List<Booking> bookings, Map<String,Integer> provided_services) {

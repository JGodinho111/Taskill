...
public class GoogleSignInActivity extends LogInActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("465467134998-0b1cgdp0933j058ue5t9dsp7omug6tkd.apps.googleusercontent.com")
                .requestEmail()
                .build();
    ...
    private void updateUI(FirebaseUser user) {
        Intent intent= new Intent(GoogleSignInActivity.this,MainActivityBot.class);

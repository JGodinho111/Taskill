...
public class ElectricianServiceFragment extends Fragment {

    private RecyclerView mFirestoreList;
    private FirebaseDatabase firebaseDatabase;
    private ServicesModelAdapter adapter;

    private FragmentElectricianServiceBinding binding;
    ...
    public ElectricianServiceFragment() {
    ...
    public ElectricianServiceFragment newInstance(String param1, String param2) {
        ElectricianServiceFragment fragment = new ElectricianServiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        binding = FragmentElectricianServiceBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        firebaseDatabase = FirebaseDatabase.getInstance();

        mFirestoreList = root.findViewById(R.id.firestore_list_electrician);
        ...
        Query query = serviceProvidersRef.orderByChild("provided_services/electrician");
        ...
        adapter = new ServicesModelAdapter(options,getContext(), "electrician");

        mFirestoreList.setAdapter(adapter);

        View v = inflater.inflate(R.layout.fragment_electrician_service, container, false);

...
public class LockSmithServiceFragment extends Fragment {
    ...
    private FragmentLockSmithServiceBinding binding;
    ...
    public LockSmithServiceFragment() {
    ...
    public LockSmithServiceFragment newInstance(String param1, String param2) {
        LockSmithServiceFragment fragment = new LockSmithServiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        binding = FragmentLockSmithServiceBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        firebaseDatabase = FirebaseDatabase.getInstance();

        mFirestoreList = root.findViewById(R.id.firestore_list_locksmith);
        ...
        View v = inflater.inflate(R.layout.fragment_lock_smith_service, container, false);

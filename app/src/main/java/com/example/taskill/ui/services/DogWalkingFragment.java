...
public class DogWalkingFragment extends Fragment {
    ...
    private FragmentDogWalkingBinding binding;
    ...
    public DogWalkingFragment newInstance(String param1, String param2) {
        DogWalkingFragment fragment = new DogWalkingFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        binding = FragmentDogWalkingBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        firebaseDatabase = FirebaseDatabase.getInstance();

        mFirestoreList = root.findViewById(R.id.firestore_list_dogwalking);
        ...
        View v = inflater.inflate(R.layout.fragment_dog_walking, container, false);

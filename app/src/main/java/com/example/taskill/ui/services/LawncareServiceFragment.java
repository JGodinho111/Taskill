...
public class LawncareServiceFragment extends Fragment {
    ...
    private FragmentLawncareServiceBinding binding;
    ...
    public LawncareServiceFragment() {
    ...
    public LawncareServiceFragment newInstance(String param1, String param2) {
        LawncareServiceFragment fragment = new LawncareServiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        binding = FragmentLawncareServiceBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        firebaseDatabase = FirebaseDatabase.getInstance();

        mFirestoreList = root.findViewById(R.id.firestore_list_lawncare);
        ...
        View v = inflater.inflate(R.layout.fragment_lawncare_service, container, false);
